// src/app/classes/components/AddClassForm.tsx
"use client";
import { Plus, GraduationCap } from "lucide-react";
import { UseAddClassFormProps } from '../types/class';
import { useAddClassForm } from "../_hooks";

export const AddClassForm = ({ onAdded }: UseAddClassFormProps) => {
  const {
    name,
    setName,
    description,
